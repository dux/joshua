# Canonical reference example for the Joshua DSL.
...
Joshua.plugin :kitchen_sink_plugin do
  def plugin_provided
    'from_plugin'
  end
end
...
class KitchenSinkBaseApi < Joshua
  mount_on '/kapi'
...
class KitchenSinkApi < KitchenSinkBaseApi
  ...
  class_detail 'Exercises every Joshua DSL feature in one class.'
