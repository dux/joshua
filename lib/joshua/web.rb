...
# whitelisted file under lib/web/ can be served. Paths are always
# interpreted relative to lib/web/ - a leading '/' is allowed as
...
#   - no scheme (e.g. http://)
#   - resolved file must live under lib/web/
...
class Joshua
  module Web
    ...
    def render file: nil
      ...
      # strip leading '/' - URL sugar meaning "root of lib/web/"
      rel = raw.sub(/^\/+/, '')
