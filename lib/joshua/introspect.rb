# Single source of truth for everything Joshua knows about its API surface.
...
class Joshua
  module Introspect
    ...
    def apis mount_on
      ...
      Joshua.documented.each do |klass|
        next if klass.to_s == 'Joshua::SysApi'
    ...
    # build the per-method entry; strips private (_*) keys like :_typero
